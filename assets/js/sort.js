	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		serialize: function(o) {
			...
			$(items).each(function() {
				...
				var oid = ($(o.item || this).parent(o.listType).parent('li').attr(o.attribute || 'rel') || '').match(o.expression || (/(.+)[-=_](.+)/));
				
				if(res) str.push((o.key || ''+(o.key && o.expression ? res[1] : res[2])+'-')+ +(pid ? (o.key && o.expression ? pid[1] : pid[2]) : '0')+'-'+(oid ? (o.key && o.expression ? oid[1] : oid[2]) : '0'));
			});
